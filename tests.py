...
class MyTest(TestCase):
    ...
    def test_delete_transaction(self):
        ...
        a = q.Transaction(user_id=1, stock_id=1, quantity=1, price=1, type='buy')
        b = q.Transaction(user_id=1, stock_id=2, quantity=2, price=2, type='buy')
        db.session.add(a)
        db.session.add(b)
        db.session.commit()
    ...
    def test_build_history(self):
        ...
        self.populateTestDb()
        history = f.build_history(q.select_transactions_by_user(1))
    ...
    def test_usd(self):
        ...
        assert f.usd(800) == "$800.00"
        assert f.usd(0) == "$0.00"
        assert f.usd(9.99) == "$9.99"
